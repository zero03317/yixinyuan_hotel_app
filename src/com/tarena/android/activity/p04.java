...
public class p04 extends Activity {
	private GridView gv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.grid_homepage_test);
        ...
        gv.setOnItemClickListener(new OnItemClickListener() {
        	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
        		...
        		// Ԥ����Ʊ�����ѯ
        		if(arg2==0){
        			Intent it=new Intent(p04.this,p05.class);
        	        startActivity(it);
        		}
        		
                // ����������?��ת��p12ҳ��
        		if(arg2==1){
        			Intent it1=new Intent(p04.this,p12.class);
        	        startActivity(it1);
        		}
        		
        		if(arg2==2){
        			Intent it2=new Intent(p04.this,p16.class);
        	        startActivity(it2);
        		}
        		
        		if(arg2==3){
        			Intent it3=new Intent(p04.this,p21.class);
        	        startActivity(it3);
        		}
        		
        		if(arg2==4){
        			Intent it4=new Intent(p04.this,p19.class);
        	        startActivity(it4);
        		}
        		
        		if(arg2==5){
        			Intent it5=new Intent(p04.this,p13.class);
        	        startActivity(it5);
        		}
        		
        		if(arg2==6){
        			Intent it=getIntent();
        			String ID = String.valueOf(it.getStringExtra("_id"));
        			Intent it6=new Intent(p04.this,p23.class);
        			it6.putExtra("_id", ID);
        	        startActivity(it6);
        		}
        		
        		if(arg2==7){
        			Intent it7=new Intent(p04.this,p27.class);
        	        startActivity(it7);
        		}
        		if(arg2==8){
        			Intent it8=new Intent(p04.this,aboutus.class);
        	        startActivity(it8);
        		}
